...
class EnergySmearLY(Smear):
    ...
    def calc_poisson_energy(self, x, lamb):
        ...
        if self._log_factorial.has_key(photons) == False:
            self._log_factorial[photons] = numpy.sum(numpy.log(numpy.arange(1,(photons+1))))
        logPois = photons*numpy.log(expected) - self._log_factorial[photons] - expected#*numpy.log(numpy.e)
